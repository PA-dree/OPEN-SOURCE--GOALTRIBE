...
class MainActivity : AppCompatActivity() {
    ...
    private fun listenToGoals(uid: String) {
        ...
        goalsListener = db.collection("users").document(uid).collection("goals")
            .addSnapshotListener { snapshot, error ->
                if (error != null) { Log.e(TAG, "Error listening to goals: $error"); return@addSnapshotListener }
    ...
    private fun showSettingsDialog() {
        ...
        radioEnglish.setOnClickListener { currentLanguage = "en"; translateUI(currentLanguage); Toast.makeText(this, "English selected", Toast.LENGTH_SHORT).show() }
        radioZulu.setOnClickListener { currentLanguage = "fr"; translateUI(currentLanguage); Toast.makeText(this, "Zulu selected", Toast.LENGTH_SHORT).show() }
    ...
    private fun showAddGoalDialog() {
        ...
        btnSave.setOnClickListener {
            ...
            db.collection("users").document(user.uid).collection("goals").add(newGoal)
                ...
                .addOnFailureListener { e -> Log.e(TAG, "Error saving goal: ${e.message}"); Toast.makeText(this, "Error saving goal: ${e.message}", Toast.LENGTH_LONG).show() }
        }
